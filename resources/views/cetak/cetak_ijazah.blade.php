...
<body onload="window.print();">
	...
	<div class="wrapper">
		<div class="container">
		<div style="margin-top:118px;margin-left:99px;margin-right:99px;">
            ...
            <div style="margin-top:40px;">
                <h5 style='text-align:center;font-weight:400;color:transparent'> KEMENTRIAN PENDIDIKAN</h5>
                <h5 style='text-align:center;font-weight:400;color:transparent'> KEBUDAYAAN RISET DAN TEKNOLOGI</h5>
                <h5 style='text-align:center;font-weight:400;color:transparent'> REPUBLIK INDONESIA</h5>
                    <br>
                    <br>
                   
                    <h5 style='text-align:center;font-weight:600;color:transparent'> IJAZAH</h5>
                    <br>
                    <br>
                <h5 style='text-align:center;font-weight:400;color:transparent'> SEKOLAH MENENGAH ATAS</h5>
                <h5 style='text-align:center;font-weight:400;color:transparent'> PEMINATAN MATEMATIKA DAN ILMU PENGETAHUAN ALAM</h5>
                 <h5 style='text-align:center;font-weight:400;color:transparent'> TAHUN PELAJARAN {{ date('Y', strtotime('-1 year')) }}/{{date('Y')}}</h5>
              </div>
        <div style="position:relative;left:140px;width:100%;margin-top:40px;margin-bottom:80px">
            <div style="margin-top:50px;margin-right:300px;">
                ...
                <h5 style='text-align:center;font-weight:600;color:transparent'> LULUS</h5>
                <br>
                <br>
                <p style="color:transparent">Dari sekolah menengah atas setelah memenuhi seluruh kriteria sesuai dengan</p>
                <p style="color:transparent">Peraturan perundang - undangan yang diumumkan pada tanggal </p>
        ...
        <div style="margin-left:400px;margin-top:5px">
            <div style="display:inline-block">
                <span style="margin:35px 15px;color:transparent">NIP.</span>
            </div>
        </div>
